 ...
 * BACKFILL PAGE 5
 * 
 * "How much did you follow your intuition yesterday?" (1–10)
 * 
...
export default function BackfillPage5() {
    const [selectedRating, setSelectedRating] = useState<number | null>(null)
    const [loading, setLoading] = useState(false)
    const [error, setError] = useState<string | null>(null)

    useEffect(() => {
        logPageVisit('v1-bf-5')
    }, [])
    ...
    async function handleSubmit() {
        ...
        formData.set('nextPage', '/morning/backfill/6')
    ...
    return (
        <div className="w-full max-w-md text-center">
            {/* Page counter */}
            <p className="text-gray-600 text-sm mb-16">5 / 9</p>

            {/* Main question */}
            <h1 className="text-2xl font-semibold text-white mb-12 leading-relaxed">
                How much did you follow your intuition yesterday?
            </h1>
