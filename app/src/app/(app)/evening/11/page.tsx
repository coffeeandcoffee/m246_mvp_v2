...
export default function EveningPage11() {
    const [selectedRating, setSelectedRating] = useState<number | null>(null)
    const [loading, setLoading] = useState(false)
    const [error, setError] = useState<string | null>(null)

    useEffect(() => {
        logPageVisit('v1-e-11')
    }, [])
    ...
    async function handleSubmit() {
        ...
        formData.set('nextPage', '/evening/12')
    ...
    return (
        <div className="w-full max-w-md text-center">
            {/* Page counter */}
            <p className="text-gray-600 text-sm mb-16">11 / 14</p>

            {/* Main question */}
            <h1 className="text-2xl font-semibold text-white mb-12 leading-relaxed">
                How much doubt did you feel?
            </h1>
