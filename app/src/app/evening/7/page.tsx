/**
 * EVENING PAGE 7 (v1-e-7)
 * 
 * "How positive today?" (1–10)
 * 
...
export default function EveningPage7() {
    ...
    async function handleSubmit() {
        ...
        formData.set('nextPage', '/evening/8')
    ...
    return (
        <div className="w-full max-w-md text-center">
            {/* Page counter */}
            <p className="text-gray-600 text-sm mb-16">7 / 14</p>

            {/* Main question */}
            <h1 className="text-2xl font-semibold text-white mb-12 leading-relaxed">
                How positive did you feel today?
            </h1>
